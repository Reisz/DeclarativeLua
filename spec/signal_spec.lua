...
describe("Component signals", function()
  ...
  it("should be able to disconnect member functions", function()
    ...
    local o = { f = function() s1() end, g = function() s2() end }
    c:connect("test", o, "f")
    c:connect("test", o, "g")
    c:emit("test")
    c:disconnect("test", o, "f")
    c:emit("test")
    assert.spy(s1).was_called(1)
    assert.spy(s2).was_called(2)
  end)
  ...
  it("should be able to disconnect one member of callables", function()
    local c = Component{ Component.signal("test") }()
    local s1, s2, s3 = spy.new(function() end), spy.new(function() end),
      spy.new(function() end)
    local o = setmetatable({ f = s1, g = s2 }, { __call = function() s3() end })
    c:connect("test", o, "f")
    c:connect("test", o, "g")
    c:emit("test")
    c:disconnect("test", o, "f")
  ...
  it("should be able to disconnect all members of callables", function()
    local c = Component{ Component.signal("test") }()
    local s1, s2, s3 = spy.new(function() end), spy.new(function() end),
      spy.new(function() end)
    local o = setmetatable({ f = s1, g = s2 }, { __call = function() s3() end })
  ...
  it("should be able to disconnect everything from a single signal", function()
    local c = Component{ Component.signal("test") }()
    local s1, s2, s3, s4 = spy.new(function() end), spy.new(function() end),
      spy.new(function() end), spy.new(function() end)
    local o1 = { f = s2 }
    local o2 = setmetatable({ f = s3 }, { __call = function() s4() end })
    c:connect("test", s1)
    c:connect("test", o1, "f")
    c:connect("test", o2, "f")
    c:emit("test")
    ...
    assert.spy(s2).was_called(1)
    assert.spy(s3).was_called(1)
    assert.spy(s4).was_called(0)
  end)

  it("should be able to disconnect a function from every signal", function()
    local c = Component{ Component.signal("test1"), Component.signal("test2") }()
    local s1, s2 = spy.new(function() end), spy.new(function() end)
    c:connect("test1", s1)
    c:connect("test1", s2)
    c:connect("test2", s1)
  ...
  it("should be able to disconnect a member from every signal", function()
    local c = Component{ Component.signal("test1"), Component.signal("test2") }()
    local s1, s2 = spy.new(function() end), spy.new(function() end)
    local o = { f = s1, g = s2 }
    c:connect("test1", o, "f")
  ...
  it("should be able to disconnect everyting", function()
    local c = Component{ Component.signal("test1"), Component.signal("test2") }()
    local s1, s2, s3 = spy.new(function() end), spy.new(function() end),
      spy.new(function() end)
    local o = { f = s1, g = s2 }
